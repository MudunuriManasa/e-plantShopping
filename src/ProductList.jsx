...
function ProductList() {
  ...
  const handlePlantsClick = (e) => {
    e.preventDefault();
    setShowCart(false); // Show the product list
  };
  ...
  const handleContinueShopping = () => {
    console.log("Switching back to product list"); // Debugging log
    setShowCart((prev) => {
      console.log("Previous showCart state:", prev); // Debugging log for state
      return false;
    });
  };
