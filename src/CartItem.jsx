...
const CartItem = ({ onContinueShopping }) => {
  ...
  const handleContinueShopping = (e) => {
    ...
    console.log("Continue shopping clicked"); // Debug log
    console.log("onContinueShopping prop in CartItem:", onContinueShopping);
      ...
      {cart.map((item) => (
        <div className="cart-item" key={item.name}>
          ...
          <div className="cart-item-details">
            ...
            <div className="cart-item-total">Subtotal: ${(item.cost * item.quantity).toFixed(2)}</div>
